 ...
 *
 * Assertions target Prisma's known error codes and Zod DTO schema rules:
 * - P2002: Unique constraint violation (uq_return_line_item)
 * - P2003: Foreign key constraint violation (return_id, item_id, siv_line_id)
 */
