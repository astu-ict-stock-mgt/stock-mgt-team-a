...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  ADMIN: [
    ...
    // Ledger & Operational Oversight (Read-Only)
  ...
  // NOTE: REQUISITIONS_CREATE is intentionally excluded — creating requisitions is the REQUESTER's job.
  // The Dept Head's only issuing action is to approve or reject submitted requisitions from their team.
  DEPARTMENT_HEAD: [
    PERMISSIONS.MASTER_DATA_READ,
    PERMISSIONS.STOCK_CARDS_READ,
    PERMISSIONS.INVENTORY_READ,
